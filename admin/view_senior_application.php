...
<div class="header">
        ...
        <div class="text-right mt-3 no-print">
            <a href="index.php" class="btn btn-secondary btn-flat">Back</a>
      
            <a class="btn btn-primary btn-flat acceptUser" href="javascript:void(0)" data-id="<?php echo $row['sc_id'] ?>">Accept</a>
